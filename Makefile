...
obj/main.o: src/main.cpp include/Board.h include/DisjointDatabase.h include/Idastar.h include/Idastar-inl.h include/ctpl_stl.h include/InputParser.h | obj
	$(CXX) $(CXXFLAGS) -c -o $@ $<
obj/Board.o: src/Board.cpp include/Board.h include/DisjointDatabase.h include/Point.h | obj
	$(CXX) $(CXXFLAGS) -c -o $@ $<
...
obj/InputParser.o: src/InputParser.cpp include/InputParser.h | obj
	$(CXX) $(CXXFLAGS) -c -o $@ $<
obj/PartialDatabase.o: src/PartialDatabase.cpp include/PartialDatabase.h include/Pattern.h include/flat_hash_map.h | obj
	$(CXX) $(CXXFLAGS) -c -o $@ $<
